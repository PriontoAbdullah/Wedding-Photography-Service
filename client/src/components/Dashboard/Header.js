      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 -mb-px">
          ...
          <div className="flex items-center">
            {/* search button*/}
            <button
              className="w-8 h-8 flex items-center justify-center bg-red-50 hover:bg-gray-200 transition duration-150 rounded-full mx-3"
            ...
            <button
              className="w-8 h-8 flex items-center justify-center bg-red-50 hover:bg-gray-200 transition duration-150 rounded-full"
              aria-haspopup="true"
            >

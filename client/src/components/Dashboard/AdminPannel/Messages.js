            ...
            <div className="flex flex-col">
              <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                  <div className="shadow-3xl overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table className="min-w-full divide-y divide-gray-200 font-body">
                      <thead className="bg-red-50">
                        <tr>
                          ...
                          <th
                            scope="col"
                            className="px-6 py-3 text-end text-xs font-semibold text-gray-800 uppercase tracking-wider"
                          >
                            Action
                          </th>
                        </tr>

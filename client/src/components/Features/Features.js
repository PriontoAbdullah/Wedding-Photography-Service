    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-24">
      <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
        ...
        <div className="lg:w-1/2">
          <p className="font-body text-base text-gray-700 md:text-lg">
            ...
            on time on your wedding day. When you hire us, we are contractually
            obligated to carry out the duties that you hired us to perform !
          </p>
        </div>
      </div>
      <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <p className="mb-3 font-body text-sm text-gray-700 leading-normal">
            We are a professional photography team with contemporary approach at
            capturing all wedding’s most amazing moments.
          </p>
          <ul className="mb-4 -ml-1 space-y-2 font-body text-base text-gray-800">
            <li className="flex items-start">
              <CheckCircle />
